<template>
  <div class="mx-5">
    <div class="mx-auto max-w-5xl">
      <header>
        <h1
          class="text-6xl leading-normal mb-2 font-serif text-gray-700 dark:text-gray-100 transition-colors"
        >
          Snapshot Voting
        </h1>
      </header>
      ...
      <h1
        class="text-2xl leading-normal mb-2 font-serif text-gray-700 dark:text-gray-100 transition-colors"
      >
        Space
      </h1>
