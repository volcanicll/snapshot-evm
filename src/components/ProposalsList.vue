<template>
  <div class="min-h-full">
    <div class="overflow-x-auto w-full">
      <table
        class="mx-auto w-full rounded-lg bg-white divide-gray-300 overflow-hidden"
      >
        <thead class="bg-gray-900">
          <tr class="text-white text-left">
            ...
            <th
              class="font-semibold text-sm uppercase px-2 py-2 text-center hidden md:table-cell"
            >
              Voting Start Time
            </th>
            <th
          ...
          >
            <td class="px-2 py-2 text-center">
              <input
                ...
                :value="proposal.select"
                @change.stop="selectChange($event.target.value, proposal)"
                class="w-12 border-solid border-2 rounded-md"
              />
            </td>
            <td
